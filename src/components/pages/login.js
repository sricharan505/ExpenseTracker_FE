...
const Login = () => {
  ...
  if (isloading) {
    return (
      <div className="absolute w-full h-full bg-orange-200 flex flex-col justify-center align-center items-center">
        <div className="">
          <svg width="100" height="100" viewBox="0 0 312.5 312.5">
        ...
        <div className="text-3xl flex">
          <p className="">Getting you in</p>
          <p className="text-7xl ml-1 pb-2 flex flex-col justify-end loginloading1">
            <svg
              viewBox="0 0 48 48"
              xmlns="http://www.w3.org/2000/svg"
              fill="#FF0000"
          ...
          <p className="text-7xl ml-1 pb-2 flex flex-col justify-end loginloading2">
            <svg
              viewBox="0 0 48 48"
              xmlns="http://www.w3.org/2000/svg"
              fill="#0b6b24"
          ...
          <p className="text-7xl ml-1 pb-2 flex flex-col justify-end loginloading3">
            <svg
              viewBox="0 0 48 48"
              xmlns="http://www.w3.org/2000/svg"
              fill="#0000FF"
  ...
  return (
    <div className="flex justify-center md:justify-start items-center w-full h-screen loginbg  sm:px-36 md:px-24 md:py-8 lg:py-8">
      {/* <div className="hidden sm:inline w-1/6"></div> */}
      <div className="sm:max-w-sm flex flex-col  justify-center text-lg bg-gradient-to-b from-violet-500 via-purple-700 to-purple-900 border rounded-md h-full w-full md:w-4/6  lg:w-2/6 xl:w-1/4">
